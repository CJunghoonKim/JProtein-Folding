...
public class AminoIndex {
	/**
	 * Amino acid abbreviations and corresponding numerical indices
	 */
	public static final char[] ACID_ABBV = {'C', 'M', 'F', 'I', 'L', 'V', 'W', 'Y', 'A', 'G',
											'T', 'S', 'N', 'Q', 'D', 'E', 'H', 'R', 'K', 'P'};
	...
	public static final Map<Character, Double> ACID_WEIGHT = new HashMap<Character, Double>() {{
		put('A', 89.094);
		put('R', 174.203);
		put('N', 132.119);
		put('D', 133.104);
	...
	/**
	 * Residue-residue Miyazawa-Jernigan energy potentials in RT units
	 * 
	 * For more info see: Miyazawa S., Jernigan R.L., J Mol Biol. 1996 Mar 1;256(3):623-44,
	 * DOI: 10.1006/jmbi.1996.0114
	 */
	public static final double[][] ACID_RR_E = 
			// Indices from ACID_ABBV correspond to residue-residue potentials in this energy index
